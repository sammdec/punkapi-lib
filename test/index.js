...
const random = require("../dist/punkapi-lib.js").random
const beer = require("../dist/punkapi-lib.js").beer
const beers = require("../dist/punkapi-lib.js").beers
...
describe(".beers()", function() {
  ...
  it("should return beers brewed after 02/2014", function(done) {
    ...
    const brewedDate = moment(beers(opts)[0].first_brewed, "MM/YYYY").format(
      "X"
    )
