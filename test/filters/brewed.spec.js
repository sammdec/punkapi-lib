...
const brewedBeforeFilter = require("../../dist/filters/brewed")
  .brewedBeforeFilter
const brewedAfterFilter = require("../../dist/filters/brewed").brewedAfterFilter

describe("brewedBeforeFilter", function() {
  it("should return Punk IPA 2010 if date is 11-2010", function() {
    brewedBeforeFilter("11-2010", db).should.containDeep([
      { name: "Punk IPA 2010 - Current" }
    ])
  })

  it("should not return Punk IPA 2010 if date is 09-2009", function() {
    brewedBeforeFilter("09-2009", db).should.not.containDeep([
      { name: "Punk IPA 2010 - Current" }
    ])
  })
})
